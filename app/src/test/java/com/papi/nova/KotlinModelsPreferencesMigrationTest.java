...
public class KotlinModelsPreferencesMigrationTest {
    @Test
    public void selectedModelAndPreferenceClassesAreKotlinSources() {
        String[] paths = {
    ...
    @Test
    public void sensitivityBeanKeepsJavaBeanAccessors() {
    ...
    @Test
    public void settingsProfileKeepsMutableProfileApi() {
        UUID id = UUID.randomUUID();
        Map<String, Object> options = new HashMap<>();
        options.put("checkbox_ultra_low_latency", true);
        SettingsProfile profile = new SettingsProfile(id, "Handheld", 10L, 20L, options);
    ...
    @Test
    public void preferenceConfigurationKeepsJavaFieldAndStaticApi() {
