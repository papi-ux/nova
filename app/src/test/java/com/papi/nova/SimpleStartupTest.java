...
public class SimpleStartupTest {
    ...
    public void testApplicationCreation() {
        ...
        NovaApplication app = new NovaApplication();
        assertNotNull("Application should be created", app);
    }

    @Test
    public void testApplicationOnCreate() {
        // The Application is already created by Robolectric via ApplicationProvider.
        // Verify ProfilesManager was initialized during that process.
        NovaApplication app = (NovaApplication) ApplicationProvider.getApplicationContext();
