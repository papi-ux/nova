...
object ShaderUtils {
    ...
    const val FRAGMENT_SHADER_3D: String =
     ...
     */
    const val OPTIMIZED_SINGLE_PASS_GAUSSIAN_BLUR_SHADER: String =
        "precision mediump float;\n" +
            "varying vec2 v_TexCoord;\n" +
    ...
    const val EDGE_AWARE_VERTEX_SHADER: String =
        "attribute vec4 a_Position;\n" +
            "attribute vec2 a_TexCoord;\n" +
            "varying vec2 v_TexCoord;\n" +
            "void main(){\n" +
    ...
    const val EDGE_AWARE_DEPTH_BLUR_SHADER: String =
        "precision mediump float;\n" +
            "varying vec2 v_TexCoord;\n" +
